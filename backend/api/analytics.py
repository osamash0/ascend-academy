...
async def get_lecture_overview(lecture_id: str):
...
async def get_slide_analytics(lecture_id: str):
...
async def get_quiz_analytics(lecture_id: str):
...
async def get_student_performance(lecture_id: str):
