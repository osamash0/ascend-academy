...
% scrreprt is a report class: the book-only sectioning commands are not
% defined here, so page numbering is switched explicitly instead.
\pagenumbering{roman}
...
\appendix
\include{chapters/appendix-a-constants}
