...
| 2 | Marketing site (`/`) | 🟠 Renders well, but every footer link is dead (`href="#"`). The "2 of 6 feature cards never become visible" claim this row used to carry is **[retracted](#2--marketing-site-)** — measurement artifact, not a bug. |
