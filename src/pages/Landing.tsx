...
import { captureLandingAttribution } from '@/services/onboardingAttribution';
          ...
          >
            ...
            <div className="relative rounded-2xl border border-white/10 bg-[#0d1326]/90 backdrop-blur-xl overflow-hidden">
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-white/5">
                ...
                <span className="text-xs text-amber-300 font-mono">{t('landing:professors.preview.sample')}</span>
              </div>

              <div className="p-6 space-y-4" aria-label={t('landing:professors.preview.sample') }>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#features" className="text-sm text-slate-500 hover:text-cyan-400 transition-colors">{t('landing:footer.links.features')}</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href={PublicRoutes.DATENSCHUTZ} className="text-sm text-slate-500 hover:text-cyan-400 transition-colors">{t('landing:footer.privacyPolicy')}</a>
              </li>
              <li>
                <a href={PublicRoutes.IMPRESSUM} className="text-sm text-slate-500 hover:text-cyan-400 transition-colors">{t('landing:footer.imprint')}</a>
              </li>
            </ul>
          </div>
        </div>
