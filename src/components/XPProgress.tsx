...
export const XPProgress = memo(function XPProgress({ currentXP, currentLevel, streak }: XPProgressProps) {
  ...
  return (
    <div ref={ref} className="glass-card border-white/5 p-8 rounded-[32px] relative overflow-hidden group">
        ...
        <div className="flex items-center gap-5">
          <div className="relative">
            ...
            <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-lg bg-xp flex items-center justify-center border-2 border-background shadow-lg">
              <Zap className="w-3 h-3 text-white fill-current" aria-hidden="true" />
            </div>
          </div>
          <div>
