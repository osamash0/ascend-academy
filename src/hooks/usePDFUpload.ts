...
interface UsePDFUploadOptions {
  ...
  parserChoice?: 'auto' | 'pymupdf' | 'opendataloader' | 'mineru' | 'llamaparse' | 'markitdown';
}
...
export function usePDFUpload({ setSlides, setActiveSlideIndex, title, setTitle, parserChoice = 'auto' }: UsePDFUploadOptions) {
  ...
  const startUpload = useCallback(
    ...
    [aiModel, parsingMode, parserChoice, setSlides, setActiveSlideIndex, title, setTitle, toast],
  );
