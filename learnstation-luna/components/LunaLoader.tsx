  ...
  const renderLoader = () => {
    switch (type) {
      ...
      case 'byte-thruster':
        return (
          <svg viewBox="0 0 80 80" width={size} height={size} style={{ overflow: 'visible' }}>
            <ellipse cx="40" cy="72" rx="13" ry="3" fill="#0D0A14" opacity="0.4">
              <animate attributeName="rx" values="13;9;13" dur="2.6s" repeatCount="indefinite" />
            </ellipse>
            <g>
              <animateTransform attributeName="transform" type="translate" values="0 0; 0 -6; 0 0" dur="2.6s" repeatCount="indefinite" calcMode="spline" keySplines="0.45 0 0.55 1; 0.45 0 0.55 1" />
              <line x1="40" y1="18" x2="40" y2="10" stroke="#88B0B5" strokeWidth="2" strokeLinecap="round" />
              <circle cx="40" cy="7" r="3" fill="#FFD93D">
                <animate attributeName="opacity" values="1;0.2;1" dur="1.2s" repeatCount="indefinite" />
              </circle>
              <rect x="24" y="20" width="32" height="30" rx="9" fill="#4A3F6B" stroke="#2D2445" strokeWidth="1.5" />
              <rect x="28" y="24" width="24" height="20" rx="5" fill="#1A1425" opacity="0.9" stroke="#6B5B95" strokeWidth="1" />
              <circle cx="35" cy="34" r="3" fill="white" stroke="#4A3F6B" strokeWidth="0.6" />
              <circle cx="35" cy="34" r="1.5" fill="#4A3F6B" />
              <circle cx="45" cy="34" r="3" fill="white" stroke="#4A3F6B" strokeWidth="0.6" />
              <circle cx="45" cy="34" r="1.5" fill="#4A3F6B" />
              <path d="M34 40 Q40 43 46 40" stroke="#88B0B5" strokeWidth="1.2" fill="none" strokeLinecap="round" />
              <rect x="30" y="50" width="20" height="16" rx="6" fill="#FFF8E7" stroke="#4A3F6B" strokeWidth="1.2" />
              <path d="M28 58 Q34 68 40 58" fill="#FFD93D" opacity="0.6">
                <animate attributeName="d" values="M28 58 Q34 68 40 58;M26 58 Q34 72 42 58;M28 58 Q34 68 40 58" dur="0.3s" repeatCount="indefinite" />
              </path>
            </g>
          </svg>
        );

      case 'nebula-experiment':
        return (
          <svg viewBox="0 0 80 80" width={size} height={size}>
            <path d="M32 26 L32 36 L22 54 Q20 60 28 60 L52 60 Q60 60 58 54 L48 36 L48 26 Z" fill="#88B0B5" opacity="0.3" stroke="#4A3F6B" strokeWidth="1.5" />
            <rect x="29" y="20" width="22" height="8" rx="2" fill="#E8E4F0" stroke="#4A3F6B" strokeWidth="1.2" />
            <circle cx="34" cy="56" r="3.5" fill="#FFD93D" opacity="0.8">
              <animate attributeName="cy" values="56;42;56" dur="1.6s" repeatCount="indefinite" />
              <animate attributeName="opacity" values="0.8;0.1;0.8" dur="1.6s" repeatCount="indefinite" />
            </circle>
            <circle cx="44" cy="58" r="3" fill="#E8A598" opacity="0.7">
              <animate attributeName="cy" values="58;44;58" dur="1.9s" repeatCount="indefinite" begin="0.3s" />
              <animate attributeName="opacity" values="0.7;0.1;0.7" dur="1.9s" repeatCount="indefinite" begin="0.3s" />
            </circle>
            <circle cx="39" cy="52" r="2.5" fill="#88B0B5" opacity="0.7">
              <animate attributeName="cy" values="52;38;52" dur="1.3s" repeatCount="indefinite" begin="0.15s" />
              <animate attributeName="opacity" values="0.7;0.1;0.7" dur="1.3s" repeatCount="indefinite" begin="0.15s" />
            </circle>
          </svg>
        );
      ...
      case 'orbit-scanning':
        return (
          <svg viewBox="0 0 80 80" width={size} height={size}>
            <ellipse cx="40" cy="40" rx="26" ry="8" fill="none" stroke="#88B0B5" strokeWidth="2" opacity="0.7" transform="rotate(-16 40 40)" />
            <circle cx="40" cy="40" r="15" fill="#6B5B95" stroke="#4A3F6B" strokeWidth="1.5" />
            <circle cx="35" cy="38" r="2.5" fill="white" stroke="#4A3F6B" strokeWidth="0.6" />
            <circle cx="35" cy="38" r="1.2" fill="#4A3F6B" />
            <circle cx="45" cy="38" r="2.5" fill="white" stroke="#4A3F6B" strokeWidth="0.6" />
            <circle cx="45" cy="38" r="1.2" fill="#4A3F6B" />
            <path d="M36 45 Q40 48 44 45" stroke="#4A3F6B" strokeWidth="1.2" fill="none" strokeLinecap="round" />
            <g>
              <animateTransform attributeName="transform" type="rotate" from="0 40 40" to="360 40 40" dur="3s" repeatCount="indefinite" />
              <path d="M40 40 L40 12" stroke="#FFD93D" strokeWidth="2" strokeLinecap="round" opacity="0.7">
                <animate attributeName="opacity" values="0.7;0.15;0.7" dur="1.2s" repeatCount="indefinite" />
              </path>
              <circle cx="40" cy="10" r="2.5" fill="#FFD93D" />
            </g>
          </svg>
        );
      ...
      case 'pixel-dash':
        return (
          <svg viewBox="0 0 80 80" width={size} height={size} style={{ overflow: 'visible' }}>
            <path d="M36 42 Q22 50 12 64" fill="#FFD93D" opacity="0.55">
              <animate attributeName="d" values="M36 42 Q22 50 12 64;M36 42 Q18 46 6 58;M36 42 Q22 50 12 64" dur="0.35s" repeatCount="indefinite" />
            </path>
            <path d="M44 44 Q34 54 28 66" fill="#E8A598" opacity="0.5">
              <animate attributeName="d" values="M44 44 Q34 54 28 66;M44 44 Q30 52 20 62;M44 44 Q34 54 28 66" dur="0.4s" repeatCount="indefinite" begin="0.05s" />
            </path>
            <circle cx="42" cy="36" r="17" fill="#FFF8E7" stroke="#4A3F6B" strokeWidth="1.8" />
            <circle cx="35" cy="33" r="5" fill="none" stroke="#88B0B5" strokeWidth="1.5" />
            <circle cx="49" cy="33" r="5" fill="none" stroke="#88B0B5" strokeWidth="1.5" />
            <line x1="40" y1="33" x2="44" y2="33" stroke="#88B0B5" strokeWidth="1.5" />
            <circle cx="35" cy="33" r="2.8" fill="white" stroke="#4A3F6B" strokeWidth="0.6" />
            <circle cx="35" cy="33" r="1.4" fill="#4A3F6B" />
            <circle cx="49" cy="33" r="2.8" fill="white" stroke="#4A3F6B" strokeWidth="0.6" />
            <circle cx="49" cy="33" r="1.4" fill="#4A3F6B" />
            <path d="M38 42 Q42 45 46 42" stroke="#4A3F6B" strokeWidth="1.5" fill="none" strokeLinecap="round" />
          </svg>
        );
      ...
      case 'pixel-heart':
        return (
          <svg viewBox="0 0 80 80" width={size} height={size}>
            <path
              d="M40 58 C24 46 16 36 16 26 C16 18 22 12 30 12 C35 12 39 15 40 19 C41 15 45 12 50 12 C58 12 64 18 64 26 C64 36 56 46 40 58 Z"
              fill="#E8A598"
              stroke="#4A3F6B"
              strokeWidth="1.8"
            >
            ...
            <circle cx="30" cy="24" r="3" fill="white" opacity="0.35" />
          </svg>
        );
      ...
      case 'stella-command':
        return (
          <svg viewBox="0 0 80 80" width={size} height={size} style={{ overflow: 'visible' }}>
            <ellipse cx="40" cy="72" rx="13" ry="3" fill="#0D0A14" opacity="0.4">
              <animate attributeName="rx" values="13;9;13" dur="4s" repeatCount="indefinite" />
            </ellipse>
            <g>
              <animateTransform attributeName="transform" type="translate" values="0 0; 0 -5; 0 0" dur="4s" repeatCount="indefinite" calcMode="spline" keySplines="0.45 0 0.55 1; 0.45 0 0.55 1" />
              <path d="M26 42 Q20 56 24 68 Q40 62 56 68 Q60 56 54 42 Z" fill="#4A3F6B" opacity="0.85">
                <animate attributeName="d" values="M26 42 Q20 56 24 68 Q40 62 56 68 Q60 56 54 42 Z;M26 42 Q16 56 22 68 Q40 63 58 68 Q64 56 54 42 Z;M26 42 Q20 56 24 68 Q40 62 56 68 Q60 56 54 42 Z" dur="4s" repeatCount="indefinite" />
              </path>
              <circle cx="40" cy="34" r="16" fill={faceFill} stroke="#4A3F6B" strokeWidth="1.5" />
              <path d="M40 18 L42 24 L48 24.5 L43.5 28 L45 34 L40 30.5 L35 34 L36.5 28 L32 24.5 L38 24 Z" fill="#FFD93D">
                <animate attributeName="opacity" values="1;0.6;1" dur="2.5s" repeatCount="indefinite" />
              </path>
              <circle cx="35" cy="33" r="2.8" fill="white" stroke="#4A3F6B" strokeWidth="0.6" />
              <circle cx="35" cy="33" r="1.4" fill="#4A3F6B" />
              <circle cx="45" cy="33" r="2.8" fill="white" stroke="#4A3F6B" strokeWidth="0.6" />
              <circle cx="45" cy="33" r="1.4" fill="#4A3F6B" />
              <path d="M36 40 Q40 43 44 40" stroke="#4A3F6B" strokeWidth="1.5" fill="none" strokeLinecap="round" />
              <circle cx="31" cy="38" r="1.8" fill="#E8A598" opacity="0.5" />
              <circle cx="49" cy="38" r="1.8" fill="#E8A598" opacity="0.5" />
              <circle cx="40" cy="52" r="4" fill="#FFD93D" stroke="#D4A017" strokeWidth="0.8" />
            </g>
          </svg>
        );
