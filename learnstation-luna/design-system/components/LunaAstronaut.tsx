    ...
    >
      ...
      >
        ...
        <g>
          ...
          {/* Suit body */}
          <rect x="48" y="96" width="64" height="56" rx="20" fill="#FFF8E7" stroke="#4A3F6B" strokeWidth="2.5" />
          <rect x="48" y="96" width="64" height="56" rx="20" fill="url(#suitGrad)" opacity="0.25" />

          {/* Neck ring */}
          <ellipse cx="80" cy="96" rx="22" ry="8" fill="#88B0B5" stroke="#4A3F6B" strokeWidth="2" />
          ...
          {/* Visor */}
          <circle cx="80" cy="56" r="34" fill={`url(#lunaVisor-${phaseNum})`} opacity="0.4" stroke="#4A3F6B" strokeWidth="1.5" />
          <circle cx="80" cy="56" r="34" fill="none" stroke="#4A3F6B" strokeWidth="2" opacity="0.6" />

          {/* Comms ring */}
          <rect x="42" y="48" width="6" height="16" rx="3" fill="#6B5B95" stroke="#4A3F6B" strokeWidth="1" />
